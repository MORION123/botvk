...
# ID чатов
# n1 - лайки 10|10 (другая беседа)
# n2 - ПОДПИСКИ 5|5 (ВАША БЕСЕДА 2000000206)
# n3 - комментарии 3|3
# n4 - лайки 20|20
n1, n2, n3, n4 = 2000000001, 2000000003, 2000000006, 2000000008
...
def main2(event) -> None:
    ...
    if event.type == VkBotEventType.MESSAGE_NEW:
        try:
            ...
            logger.info(f"🔔 Получено событие из peer_id: {z}")
...
ql = {
    ...
    n2: fol_bot,     # ПОДПИСКИ 5|5 (ваша беседа 2000000206)
...
if __name__ == '__main__':
    try:
        ...
        logger.info(f"📡 GROUP_ID: {GROUP_ID}")
        logger.info(f"🎯 Целевая беседа для подписок (n2): {n2}")
